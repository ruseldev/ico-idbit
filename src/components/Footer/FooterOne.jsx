                ...
                >
                  ...
                  <div className="footer-content">
                    ...
                    <ul className="footer-social">
                      <li>
                        <a href="https://www.instagram.com/idbit_io">
                          <i className="fab fa-instagram"></i>
                        </a>
                      </li>
                      <li>
                        <a href="https://twitter.com/idbitio">
                          <i className="fab fa-twitter"></i>
                        </a>
                      </li>
                      <li>
                        <a href=" https://m.facebook.com/people/idbitio/61557502836303/">
                          <i className="fab fa-facebook-f"></i>
                        </a>
                      </li>
                      <li>
                        <a href="https://wa.me/380947128388">
                          <i className="fab fa-whatsapp"></i>
                        </a>
                      </li>
                      <li>
                        <a href="https://Discord.com/invite/DFK3eECeX6">
